...
try {
 ...
 must((int)$q->fetchColumn()===7,'Volume 1 No. 2 (2026) must contain exactly 7 published articles');
 ...
 must((string)$q->fetchColumn()==='1-14,15-27,28-40,41-49,50-59,60-68,69-80','June 2026 page ranges are incorrect');
 ...
 must((int)$q->fetchColumn()===17,'June 2026 structured author metadata must contain 17 author records');
 pass('june_2026_issue','7 published articles, pages 1-80 and 17 structured author records');
 ...
 must((int)$q->fetchColumn()===7,'All seven June 2026 articles must contain their full published abstracts');
 pass('june_2026_full_abstracts','all 7 published abstracts are complete');
 ...
 must((int)$q->fetchColumn()===7,'All seven June 2026 articles must have linked PDF galley records');
 pass('june_2026_galleys','all 7 current-issue articles have PDF galley records');
 ...
 $galleyHashes=[
  ...
  'na-3-92cd3b733128d97299cc4152.pdf'=>'92cd3b733128d97299cc4152161f5dcdea8a8783172e8c93dcaebd9cf7fe0d8a',
  ...
  'na-7-0d5796d8e885a773a2a90266.pdf'=>'0d5796d8e885a773a2a902668aa3433f3e4ed56a56321ddc9056f861b3325de7'
 ];
 ...
 pass('bundled_june_2026_galleys','all 7 exact PDFs present with verified SHA-256 checksums');
